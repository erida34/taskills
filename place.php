    ...
    <body>
        ...
        <main>
            ...
            <section class="section section_top">
                <div class="flex container container_place">
                    <div class="place__content">
                        <div class="flex flex-cen mb-20 place__header">
                            <h1 class="place__input title_biggest text_aver place__name" name="placename"><?php echo $data['name']; ?></h1>
                        ...
                        <div>
                            ...
                            <div class="place__info-block">
                                ...
                                <span class="place__input place__adress" name="address"><?php echo $data['address']; ?></span>
                            </div>
                            ...
                            <div class="place__info-block descr-hash">
                                ...
                                <span class="place__input flex text_small text_midi hashtag hashtag_midi" name="hashtag"><?php
